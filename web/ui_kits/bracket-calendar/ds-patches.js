...
(function () {
  ...
  function TypePill({
    ...
    return /*#__PURE__*/React.createElement("span", _extends({
      style: {
        ...
        lineHeight: 1.5,
        color: `color-mix(in srgb, ${m.c} 72%, var(--text-strong))`,
        background: `color-mix(in srgb, ${m.c} 20%, transparent)`,
        border: `1px solid color-mix(in srgb, ${m.c} 50%, transparent)`,
        whiteSpace: 'nowrap',
        ...style
      }
  ...
  function StatusBadge({
    ...
    return /*#__PURE__*/React.createElement("span", _extends({
      style: {
        ...
        whiteSpace: 'nowrap',
        ...WHITE_ON_COLOR,
        background: `color-mix(in srgb, ${s.c} 92%, transparent)`,
        border: `1px solid color-mix(in srgb, ${s.c} 60%, transparent)`,
        ...style
      }
  ...
  function Badge({
    ...
    return /*#__PURE__*/React.createElement("span", _extends({
      style: {
        ...
        whiteSpace: 'nowrap',
        ...WHITE_ON_COLOR,
        background: `color-mix(in srgb, ${c} 92%, transparent)`,
  ...
  function Modal({
    ...
    }, props), /*#__PURE__*/React.createElement("style", null, `@keyframes bracket-fade{from{opacity:0}to{opacity:1}}@keyframes bracket-pop{from{opacity:0;transform:scale(.94)}to{opacity:1;transform:scale(1)}}`), onClose && /*#__PURE__*/React.createElement("button", {
      onClick: onClose,
      "aria-label": "Close",
      style: {
        position: 'absolute',
